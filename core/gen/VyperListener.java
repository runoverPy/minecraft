...
public interface VyperListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link VyperParser#string}.
	 * @param ctx the parse tree
	 */
	void enterString(VyperParser.StringContext ctx);
	/**
	 * Exit a parse tree produced by {@link VyperParser#string}.
	 * @param ctx the parse tree
	 */
	void exitString(VyperParser.StringContext ctx);
}