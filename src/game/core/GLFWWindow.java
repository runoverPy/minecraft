...
public class GLFWWindow {
    ...
    private final CharCallbackHandler charCallbackHandler;
    ...
    public GLFWWindow(String title, long monitor, boolean fullscreen) {
        ...
        charCallbackHandler = new CharCallbackHandler();
    ...
    public void addCharCallback(GLFWCharCallbackI callback) {
        charCallbackHandler.add(callback);
    }

    public void delCharCallback(GLFWCharCallbackI callbackI) {
    ...
    private abstract static class CallbackHandler<I> {
    ...
    private class CharCallbackHandler extends CallbackHandler<GLFWCharCallbackI> implements GLFWCharCallbackI {
        public CharCallbackHandler() {
        ...
        public void invoke(long window, int codepoint) {
            synchronized (callbacks) {
                callbacks.forEach(callback -> callback.invoke(window, codepoint));
            }
        }
    }
