...
public class PropTextBox extends ChildBox {
    private String text;
    private boolean centered;
    private boolean shaded;

    public PropTextBox(int width, int height, int xOffset, int yOffset, Box parent, String text, boolean centered, boolean shaded) {
